...
\include{./problem/problem_statement}
\include{./cumulants/cumulants}

\include{./gpf_in_cv/gpf_in_cv}
\include{./gpf_in_cv/effective_hamiltonian}

\appendix
\include{./total_correlation_functions/total_correlation_functions}
\include{./appendix/cumulant_calc}
\include{./fourier/fourier}
...
\bibliography{fluids_cv,fluids_general,correlation_functions,books_romanik_bibliography}
